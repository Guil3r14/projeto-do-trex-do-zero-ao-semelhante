...
function setup() {
 ...
 console.log(message)
  ...
  ground = createSprite(200,height-175,400,20);
  ...
  invisibleGround = createSprite(width/2,height-160,width,10);
...
function draw() {
  ...
  if(gameState === PLAY){
    ...
    if((keyDown("space")||touches.lenght>0) && trex.y >= height-210) {
        trex.velocityY = -12;
        jumpSound.play();
        touches= []
    }
